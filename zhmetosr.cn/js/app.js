...
$(document).ready(function(){   
    ...
    //春节倒计时
    var starttime = new Date("2025/1/1 00:00:00");
    setInterval(function () {
        ...
        $('.time').html("<p2025>新年倒计时</p>" + "<p><span>" + day + "</span>" + "天</p>");
        $(".sydate").html(syday);
    ...
    var mess = "<span></span><span class='B-span2'>祝你，新年快乐！</span><span>Hello, 2025, happy new year</span>";
    $(".Barrage").append(mess);
